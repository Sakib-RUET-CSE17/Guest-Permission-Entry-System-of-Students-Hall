...
public class New_Student extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Allotted Room No.");
        ...
        try {
            if (jTextField6.getText().equals("") || jTextField1.getText().equals("") || jTextField2.getText().equals("")) {
                ...
                if (rs.next()) {
                    ...
                    String sql1 = "insert into student(Student_ID,Name,Father,Year,Semester,room,previous_guest,img_location) values(?,?,?,?,?,?,?,?)";
                    ...
                    pst.execute();
                    student_img ob = new student_img(id);
                    ob.setVisible(true);
